...
import { type PendingUserInput } from "./types.js";
import {
...
const ComposerPendingUserInputCard = memo(function ComposerPendingUserInputCard({
  ...
  useEffect(() => {
    if (!active || !activeQuestion || isResponding || isCollapsed) return;
